...
import numpy as np
import time
from BOST_TEST import Ui_BOST_TEST
global C
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_wdi_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_wdi_2.setGeometry(QtCore.QRect(410, 350, 72, 20))
        self.label_wdi_2.setObjectName("label_wdi_2")
        self.label_wdi_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_wdi_3.setGeometry(QtCore.QRect(410, 380, 72, 20))
        self.label_wdi_3.setObjectName("label_wdi_3")
        ...
        self.label_wdi_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_wdi_4.setGeometry(QtCore.QRect(410, 410, 72, 20))
        self.label_wdi_4.setObjectName("label_wdi_4")
        ...
        self.fluorsecent_on_button_2.setGeometry(QtCore.QRect(60, 730, 121, 31))
        ...
        self.cal_rotation_button.setGeometry(QtCore.QRect(350, 780, 121, 31))
        ...
        self.z_scan_image_button.setGeometry(QtCore.QRect(350, 820, 121, 31))
        ...
        self.static_focus_button.setGeometry(QtCore.QRect(350, 860, 121, 31))
        ...
        self.Background_light_test_button.setGeometry(QtCore.QRect(350, 680, 150, 31))
        ...
        self.flat_button.setGeometry(QtCore.QRect(60, 680, 101, 31))
        self.flat_button.setObjectName("flat_button")
        self.exposure_time.setText(str(0.003))
        self.textBrowser = QtWidgets.QTextBrowser(self.centralwidget)
        self.textBrowser.setGeometry(QtCore.QRect(60, 790, 256, 192))
        ...
        self.incang_button.clicked.connect(self.chip_in)
        self.out_button.clicked.connect(self.chip_out)
        ...
        self.Resolution_button.clicked.connect(self.get_resolution_image)
        self.cal_rotation_button.clicked.connect(self.cal_rotation)
        self.z_scan_image_button.clicked.connect(self.z_get_imge)
        self.static_focus_button.clicked.connect(self.static_focus)
        self.get_x_display()
        self.get_y_display()
        self.get_z_display()
        self.fluorsecent_on_button_2.clicked.connect( self.z_read.terminate)
        #self.start()
...
##
    ...
    def nine_View(self):
        ...
        #image = self.image_16_8(image)
        image_mid = self.image_16_8(image[924:1124, 924:1124])
        image_midup = self.image_16_8(image[0:200, 924:1124])
        image_middown= self.image_16_8(image[1838:2038, 924:1124])
        image_midleft = self.image_16_8(image[924:1124, 0:200])
        image_midright = self.image_16_8(image[924:1124, 1838:2038])
        image_upright = self.image_16_8(image[0:200, 1838:2038])
        image_upleft = self.image_16_8(image[0:200, 0:200])
        image_downleft = self.image_16_8(image[1838:2038, 0:200])
        image_downright = self.image_16_8(image[1838:2038, 1838:2038])
    ...
    def zscan_start(self):
        ...
        z, fv, imgs, zFocus = com.zscan(down, up, step, show=True)  # 780,796 need to be changed!!!
        C.sendandrecv({"CCP": "LED_G CLOSE"})
    ...
    def keyReleaseEvent(self, QKeyEvent):
        ...
        return self.keyReleaseEvent(QKeyEvent)

    def keyPressEvent(self, QKeyEvent):
        if QKeyEvent.key() == QtCore.Qt.Key_Control:
            self.ctrlPressed = True
            print("The ctrl key is holding down")
        return self.keyPressEvent(QKeyEvent)
    ...
    def zoom(self, factor):
        ...
        if _factor < 0.001 or _factor > 100:
            # 防止过大过小
            return
    ...
    def measure_shading(self):
        ...
        img_show = self.image_16_8(img_resize_up)
 ...
 #       f.close()
    ...
    def cal_Modulation(self,center, rio_image):
        x = int(center[1] - 6)
        y = int(center[0] - 7)
    ...
    def get_resolution(self,file_pathname):
        ...
        for filename in os.listdir(file_pathname):
            ...
            for i in range(9):
                center, image_8bit = self.get_center(image_rio[:, :, i])
                Modulation_x, Modulation_y =  self.cal_Modulation(center, image_8bit)
 ...
 #               fvB_WT = com.WAVV(imgsmall)  # 反应照片清晰度的对焦值，小波变换
                fvB_ML = com.SML(imgsmall)  # 反应照片清晰度的对焦值，改进的拉普拉斯算子
        ...
        for cycle in range(1):
            ...
            with open(file, 'a') as f:
                ...
                for z in np.arange(zfocus - zRange, zfocus + zRange + zStep, zStep):
                    ...
                    C.sendandrecv({"CCP": "LED_G CLOSE"})
                    imgsmall = img[900:1100, 900:1100]
                    fvG_WT = com.WAVV(imgsmall)  # 反应照片清晰度的对焦值，小波变换
                    fvG_ML = com.SML(imgsmall)  # 反应照片清晰度的对焦值，改进的拉普拉斯算子
...
#        getz=zfocus - zRange+max_ind*0.2+1
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_wdi_2.setText(_translate("MainWindow", "上"))
        self.label_wdi_3.setText(_translate("MainWindow", "下"))
        self.label_wdi_4.setText(_translate("MainWindow", "步长"))
        ...
        self.fluorsecent_on_button_2.setText(_translate("MainWindow", "稳定性"))
        self.exposure_time_label.setText(_translate("MainWindow", "曝光时间"))
        self.shading_button.setText(_translate("MainWindow", "照明均匀度"))
        self.Resolution_button.setText(_translate("MainWindow", "成像质量"))
        ...
        self.z_scan_image_button.setText(_translate("MainWindow", "z扫描拍图"))
